...
@router.get('/', status_code=status.HTTP_200_OK, response_model=List[schemas.Operator], tags=["Operators"], summary="Get all operators", description="Retrieve a list of all operators.")
